...
public class SDFAnnParamNameImpl extends ASTWrapperPsiElement implements SDFAnnParamName {

  public SDFAnnParamNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDFVisitor visitor) {
    visitor.visitAnnParamName(this);
  }
