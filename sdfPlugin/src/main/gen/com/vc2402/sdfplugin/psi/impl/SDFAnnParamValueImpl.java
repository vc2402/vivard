...
public class SDFAnnParamValueImpl extends ASTWrapperPsiElement implements SDFAnnParamValue {

  public SDFAnnParamValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDFVisitor visitor) {
    visitor.visitAnnParamValue(this);
  }
