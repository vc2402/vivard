...
public class SDFAnnotationValueImpl extends ASTWrapperPsiElement implements SDFAnnotationValue {

  public SDFAnnotationValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SDFAnnParam getAnnParam() {
    return findChildByClass(SDFAnnParam.class);
  }
