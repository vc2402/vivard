...
public class SDFMapTypeImpl extends ASTWrapperPsiElement implements SDFMapType {

  public SDFMapTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SDFMapIndexType getMapIndexType() {
    return findNotNullChildByClass(SDFMapIndexType.class);
  }

  @Override
  @NotNull
  public SDFType getType() {
    return findNotNullChildByClass(SDFType.class);
  }
