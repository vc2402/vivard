...
public class SDFMetaDeclarationImpl extends ASTWrapperPsiElement implements SDFMetaDeclaration {

  public SDFMetaDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDFVisitor visitor) {
    visitor.visitMetaDeclaration(this);
  }
