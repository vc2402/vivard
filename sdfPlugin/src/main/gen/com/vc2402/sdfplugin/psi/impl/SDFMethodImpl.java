...
public class SDFMethodImpl extends ASTWrapperPsiElement implements SDFMethod {

  public SDFMethodImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SDFParams getParams() {
    return findChildByClass(SDFParams.class);
  }
