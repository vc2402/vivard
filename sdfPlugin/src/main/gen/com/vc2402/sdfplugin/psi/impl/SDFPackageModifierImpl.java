...
public class SDFPackageModifierImpl extends ASTWrapperPsiElement implements SDFPackageModifier {

  public SDFPackageModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SDFAnnotation getAnnotation() {
    return findNotNullChildByClass(SDFAnnotation.class);
  }
