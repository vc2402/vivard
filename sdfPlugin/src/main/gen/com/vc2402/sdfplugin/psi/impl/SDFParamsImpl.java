...
public class SDFParamsImpl extends ASTWrapperPsiElement implements SDFParams {

  public SDFParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SDFParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SDFParam.class);
  }
